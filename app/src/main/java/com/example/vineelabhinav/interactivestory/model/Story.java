package com.example.vineelabhinav.interactivestory.model;

import com.example.vineelabhinav.interactivestory.R;

/**
 * Created by vineel abhinav on 1/8/2018.
 */
...
public class Story {
    ...
    {
        pages=new Page[7];
        pages[0]=new Page(R.drawable.page0,R.string.page0,new Choice(R.string.page0_choice1, 1),new Choice(R.string.page1_choice2, 2));
